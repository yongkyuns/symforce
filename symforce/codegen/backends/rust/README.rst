...
``LinearCameraCal``, ``ATANCameraCal``, ``PolynomialCameraCal``, ``DoubleSphereCameraCal``, ``SphericalCameraCal``, ``OrthographicCameraCal``, and ``EquirectangularCameraCal``).  The runtime also provides a generic
``CameraCal`` trait
