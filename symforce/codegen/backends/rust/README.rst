...
``LinearCameraCal``, ``ATANCameraCal``, ``PolynomialCameraCal``, ``DoubleSphereCameraCal``, ``SphericalCameraCal``, and ``OrthographicCameraCal``).  The runtime also provides a generic
``CameraCal`` trait
